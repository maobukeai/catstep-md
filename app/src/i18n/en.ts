export const en = {
  ...
  ai: {
    ...
    showSelectionBubble: 'Show floating toolbar on text selection',
    showSelectionBubbleHint: 'Display floating format & AI bar when text is selected (disable to use shortcuts only)',
