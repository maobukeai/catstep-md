export const en = {
  ...
  agent: {
    ...
    msgReplaceSelection: 'Replace Selection',
    msgReplaceSelectionTitle: 'Extract clean polished text and replace active selection in editor',
    ...
    replacedSelectionSuccess: 'Replaced selection with polished text!',
  },
  rightSidebar: {
