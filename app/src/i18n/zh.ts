...
export const zh: I18n = {
  ...
  inbox: {
    ...
    enableCaptureHint:
      '默认关闭。开启后，SoloMD 会在 127.0.0.1（仅本机回环）监听新笔记的 POST 请求 —— 来自浏览器扩展、iOS 快捷指令、Shell 脚本或 curl 都可以。新笔记会落到工作区的待整理文件夹，并自动写入 `inbox: true`。',
    endpoint: '端点',
    statusRunning: '运行中',
    statusStarting: '启动中…',
    token: '令牌',
  ...
  agent: {
    ...
    msgCopied: '已复制',
    msgInserted: '已插入',
    modeAgentTitle: '智能体模式 (允许修改文件)',
    modeSuggestTitle: '建议模式 (只读建议)',
    modeAgent: '⚡ 智能体',
    modeSuggest: '🛡️ 建议',
