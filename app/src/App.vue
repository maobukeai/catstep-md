...
const AndroidFolderPicker = defineAsyncComponent(() => import('./components/AndroidFolderPicker.vue'));
...
const ViewsPanel = defineAsyncComponent(() => import('./components/ViewsPanel.vue'));
const ViewNoteList = defineAsyncComponent(() => import('./components/ViewNoteList.vue'));
const ViewEditorDialog = defineAsyncComponent(() => import('./components/ViewEditorDialog.vue'));
const SettingsPanel = defineAsyncComponent(() => import('./components/SettingsPanel.vue'));
const MarkdownHelp = defineAsyncComponent(() => import('./components/MarkdownHelp.vue'));
const GlobalSearch = defineAsyncComponent(() => import('./components/GlobalSearch.vue'));
const RagSearch = defineAsyncComponent(() => import('./components/RagSearch.vue'));
const CjkProofread = defineAsyncComponent(() => import('./components/CjkProofread.vue'));
