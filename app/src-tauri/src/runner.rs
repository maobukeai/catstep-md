...
pub fn run_with(initial_file: Option<String>) {
    ...
    let builder = builder.plugin(
        tauri_plugin_window_state::Builder::default()
            ...
            // FULLSCREEN and MAXIMIZED must also never be restored across cold starts —
            // restoring them traps users into an unprompted full screen / maximized boot.
            .with_state_flags(
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_tools::agent_tool_move_note,
            agent_tools::agent_tool_create_folder,
            agent_tools::agent_tool_delete_folder,
            agent_tools::agent_tool_copy_note,
